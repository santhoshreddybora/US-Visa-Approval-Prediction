...
from US_Visa.utils.main_utils import load_numpy_array_data, read_yaml, load_object, save_object
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        """
        try:
            logging.info("Using nuero_mf to get best model object and report")
